...
export default function Disclaimer({ navigateTo }: DisclaimerProps) {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 lg:px-16 py-12 md:py-20">
        ...
        <div className="prose prose-lg max-w-none font-['Poppins',sans-serif]">
          ...
          <section className="mb-10">
            ...
            <p className="text-[#6f6c90] text-[18px] leading-relaxed">
              Use of Your Integrative Health & Metabolic Hormone Health website is subject to our <button onClick={() => navigateTo("terms")} className="text-[#61a94e] hover:underline font-semibold">Terms & Conditions</button> and <button onClick={() => navigateTo("privacy")} className="text-[#61a94e] hover:underline font-semibold">Privacy Policy</button>.
            </p>
          </section>
